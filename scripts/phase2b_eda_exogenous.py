...
plt.fill_between(
    pol_df["Date"],
    0,
    pol_df["FAME_II_Active"],
    label="FAME-II Active",
    color="green",
    alpha=0.3,
)
plt.fill_between(
    pol_df["Date"],
    0,
    pol_df["PM_EDRIVE_Active"],
    label="PM E-DRIVE Active",
    color="red",
    alpha=0.3,
)
plt.fill_between(
    pol_df["Date"],
    0,
    pol_df["State_Subsidy_Active"],
    label="State Subsidies Active",
    color="purple",
    alpha=0.1,
)
