...
policy_df["FAME_II_Active"] = (
    (policy_df["Date"] >= "2019-04-01") & (policy_df["Date"] <= "2024-03-31")
).astype(int)
policy_df["PM_EDRIVE_Active"] = (
    (policy_df["Date"] >= "2024-10-01") & (policy_df["Date"] <= "2026-03-31")
).astype(int)
